...
function createColorPickersSection() {
  ...
  const fieldset = createFieldset({
    ...
    legend: `Player Colours & Effects
      <button id="openPresetBrowserBtn" type="button" title="Browse Colour Presets" aria-label="Browse Colour Presets" style="background:none;border:none;cursor:pointer;display:inline-flex;align-items:center;padding:0;color:var(--builder-accent);">
