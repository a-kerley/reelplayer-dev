...
export function contentFingerprint(page) {
  return hashContent({
    ...
    backgroundOverlayEnabled: page.backgroundOverlayEnabled,
    ...
    contentOverlayEnabled: page.contentOverlayEnabled,
    contentOverlayColor: page.contentOverlayColor,
    contentOverlayOpacity: page.contentOverlayOpacity,
    contentOverlayFullBleed: page.contentOverlayFullBleed,
    contentOverlayMarginVertical: page.contentOverlayMarginVertical,
    contentOverlayMarginHorizontal: page.contentOverlayMarginHorizontal,
...
export async function publishPage(page, slug) {
  ...
  const response = await fetch(`${WORKER_BASE_URL}/pages/${slug}`, {
    ...
    body: JSON.stringify({
      ...
      backgroundImage: page.backgroundImage || "",
      backgroundOverlayEnabled: page.backgroundOverlayEnabled === true,
      backgroundOverlayColor: page.backgroundOverlayColor || "#000000",
      ...
      contentOverlayEnabled: page.contentOverlayEnabled === true,
      ...
      contentOverlayFullBleed: page.contentOverlayFullBleed === true,
      contentOverlayMarginVertical: typeof page.contentOverlayMarginVertical === "number" ? page.contentOverlayMarginVertical : 0,
      contentOverlayMarginHorizontal: typeof page.contentOverlayMarginHorizontal === "number" ? page.contentOverlayMarginHorizontal : 0,
