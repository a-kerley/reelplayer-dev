...
export function renderColourPresetModal(currentPickrValues, reel, colourPresetModal) {
  ...
  function starIcon(filled) {
    return `<span class="preset-star" title="Set as default" aria-label="Set as default" style="display:inline-flex;vertical-align:middle;cursor:pointer;color:${filled?'#f4cd2a':'#bbb'};margin-right:0.3em;">
  ...
  function editIcon() {
    return `<span class="preset-edit" title="Rename" aria-label="Rename" style="display:inline-flex;vertical-align:middle;cursor:pointer;margin-left:0.4em;">
  ...
  function trashIcon() {
    return `<span class="preset-delete" title="Delete" aria-label="Delete" style="display:inline-flex;vertical-align:middle;cursor:pointer;margin-left:0.4em;">
  ...
  function loadBtn() {
    return `<button type="button" class="preset-load-btn" title="Load preset" aria-label="Load preset" style="margin-left:0.6em;padding:0.13em 0.55em;border-radius:3px;border:1px solid #444;background:#3a3a3a;color:#fff;font-size:0.76em;cursor:pointer;">Load</button>`;
  }
